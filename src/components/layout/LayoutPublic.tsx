...
export const LayoutPublic: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-medecci-fond relative">
      <HeaderPublic />
      ...
      {/* Floating Buttons */}
      <div className="fixed bottom-6 right-6 z-[9999] flex flex-col space-y-3 items-center">
        {/* WhatsApp Button */}
        <a
